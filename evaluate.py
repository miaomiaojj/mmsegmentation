...
submit_dir = '/content/mmsegmentation/CelebAMaskHQ/val_result'

# replace truth_dir to ground-truth path here
truth_dir = '/content/mmsegmentation/CelebAMaskHQ/mini_val_mask'

# replace output_dir to the desired output path, and you will find 'scores.txt' containing the calcuated mIoU
output_dir = '/content/mmsegmentation/CelebAMaskHQ/mini_val_image_submit'
